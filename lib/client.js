...
var Client = exports.Client = function (_BaseClient) {
    ...
    function Client(host, token, sessionId) {
    ...
    _createClass(Client, [{
        ...
        value: function _reconnect() {
            ...
            if (this.ws) this._retryTimeout = window.setTimeout(function () {
        ...
        value: function connect() {
            ...
            this.wasError = false;
            var url = (location.protocol === 'https:' ? 'wss:' : 'ws:') + '//' + this.hostName + '/ws?token=' + this.securityToken;
            if (this.sessionId) {
